...
//   fetch(`http://localhost:5152/api/groups/${id}/users`)
//     .then((response) => {
//       if (!response.ok) {
...
//   fetch(`http://localhost:5152/api/users`)
//     .then((response) => {
//       if (!response.ok) {
//         throw new Error("Request failed. Status: " + response.status);
//       }
...
//     cell4.textContent = new Date(user["dateOfBirth"])
//       .toISOString()
//       .split("T")[0];
...
//       fetch(`http://localhost:5152/api/groups/${groupId}/users/${userId}`, {
//         method: method,
//       })
//         .then((response) => {
//           if (!response.ok) {
